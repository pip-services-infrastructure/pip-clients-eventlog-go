# Development and Testing Guide <br/> EventLog Microservice Client SDK for Node.ks
...
```bash
git clone git@github.com:pip-services-infrastructure/pip-clients-eventlog-node.git
```
